...
#Region "CRUD"
    ...
    Protected Sub Consulta_Activo()
        ...
        Dim SQL_Activo As New TipoActivoSQLClass
        ...
        If ObjListActivo Is Nothing Then
            ...
            ObjListActivo = New List(Of TipoActivoClass)
    ...
    Protected Sub InsertActivo()
        ...
        objActivo.Activo_ID = Request.Form("ID")

        'validamos si la llave existe
        vl_s_IDxiste = Consulta_Repetido(objActivo.Activo_ID)
        ...
        If vl_s_IDxiste = 0 Then
            ...
            result = SQL_Activo.InsertActivo(objActivo)
...
#Region "FUNCIONES"
    ...
    Protected Function Consulta_Repetido(ByVal vp_S_ID As String)
        ...
        result = SQL_General.ReadExist("TIPOACTIVO", vp_S_ID, "TA_ID", "", "2")
        Return result
