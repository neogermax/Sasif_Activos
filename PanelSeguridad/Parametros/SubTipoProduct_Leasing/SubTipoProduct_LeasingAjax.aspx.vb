...
Public Class SubTipoProduct_LeasingAjax
...
#Region "CRUD"
    ...
    Protected Sub Consulta_TP_Leasing()
        ...
        Dim SQL_TP_Leasing As New SubTipoProduct_LeasingSQLClass
        ...
        If ObjListTP_Leasing Is Nothing Then
            ...
            ObjListTP_Leasing = New List(Of SubTipoProduct_LeasingClass)
    ...
    Protected Sub InsertTP_Leasing()
        ...
        Dim obj As New SubTipoProduct_LeasingClass
        Dim SQL_TP_Leasing As New SubTipoProduct_LeasingSQLClass
        Dim ObjListTP_Leasing As New List(Of SubTipoProduct_LeasingClass)
        ...
        obj.STP_Leasing_ID = Request.Form("ID")

        'validamos si la llave existe
        vl_s_IDxiste = Consulta_Repetido(obj.STP_Leasing_ID)
        ...
        If vl_s_IDxiste = 0 Then
            ...
            ObjListTP_Leasing.Add(obj)

            result = SQL_TP_Leasing.InsertTP_Leasing(obj)
    ...
    Protected Sub UpdateTP_Leasing()
        ...
        objTP_Leasing.STP_Leasing_ID = Request.Form("ID")
...
#Region "FUNCIONES"
    ...
    Protected Function Consulta_Repetido(ByVal vp_S_ID As String)
        ...
        result = SQL_General.ReadExist("SUB_TIPOPRODUCTO_LEASING", vp_S_ID, "STPL_ID", "", "2")
        Return result
