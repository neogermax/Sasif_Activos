...
Public Class SubTipoActivoSQLClass
...
#Region "CRUD"
    ...
    Public Function Read_AllActivo(ByVal vp_S_Filtro As String, ByVal vp_S_Opcion As String, ByVal vp_S_Contenido As String)
        ...
        If vp_S_Filtro = "N" And vp_S_Opcion = "ALL" Then
            sql.Append("SELECT STA_ID,STA_Descripcion,STA_FechaActualizacion,STA_Usuario FROM SUB_TIPOACTIVO")
        Else

            If vp_S_Contenido = "ALL" Then
                sql.Append("SELECT STA_ID,STA_Descripcion,STA_FechaActualizacion,STA_Usuario FROM SUB_TIPOACTIVO")
            Else
                sql.Append("SELECT STA_ID,STA_Descripcion,STA_FechaActualizacion,STA_Usuario FROM SUB_TIPOACTIVO " & _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function InsertActivo(ByVal vp_Obj_Activo As SubTipoActivoClass)
        ...
        sql.AppendLine("INSERT SUB_TIPOACTIVO (" & _
            "STA_ID," & _
            "STA_Descripcion," & _
            "STA_FechaActualizacion," & _
            "STA_Usuario" & _
            ")")
        sql.AppendLine("VALUES (")
        sql.AppendLine("'" & vp_Obj_Activo.STActivo_ID & "',")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function UpdateActivo(ByVal vp_Obj_Activo As SubTipoActivoClass)
        ...
        Dim sql As New StringBuilder
        Dim StrQuery As String = ""
        sql.AppendLine("UPDATE SUB_TIPOACTIVO SET " & _
                      " STA_Descripcion ='" & vp_Obj_Activo.Descripcion & "', " & _
                       " STA_FechaActualizacion ='" & vp_Obj_Activo.FechaActualizacion & "', " & _
                       " STA_Usuario ='" & vp_Obj_Activo.Usuario & "' " & _
                       " WHERE STA_ID = '" & vp_Obj_Activo.STActivo_ID & "'")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function EraseActivo(ByVal vp_Obj_Activo As SubTipoActivoClass)
        ...
        sql.AppendLine("DELETE SUB_TIPOACTIVO WHERE STA_ID = '" & vp_Obj_Activo.STActivo_ID & "'")
        StrQuery = sql.ToString
        Result = conex.StrInsert_and_Update_All(StrQuery, "2")
...
#Region "CARGAR LISTAS"
    ...
    Public Function listActivo(ByVal vp_S_StrQuery As String, ByVal vg_S_StrConexion As String)
        ...
        While ReadConsulta.Read
            ...
            objActivo.STActivo_ID = ReadConsulta.GetValue(0)
