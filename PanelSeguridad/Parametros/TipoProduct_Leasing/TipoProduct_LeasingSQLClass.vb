...
Public Class TipoProduct_LeasingSQLClass
...
#Region "CRUD"
    ...
    Public Function Read_AllTP_Leasing(ByVal vp_S_Filtro As String, ByVal vp_S_Opcion As String, ByVal vp_S_Contenido As String)
        ...
        If vp_S_Filtro = "N" And vp_S_Opcion = "ALL" Then
            sql.Append("SELECT TPL_ID,TPL_Descripcion,TPL_FechaActualizacion,TPL_Usuario FROM TIPOPRODUCTO_LEASING")
        Else

            If vp_S_Contenido = "ALL" Then
                sql.Append("SELECT TPL_ID,TPL_Descripcion,TPL_FechaActualizacion,TPL_Usuario FROM TIPOPRODUCTO_LEASING")
            Else
                sql.Append("SELECT TPL_ID,TPL_Descripcion,TPL_FechaActualizacion,TPL_Usuario FROM TIPOPRODUCTO_LEASING " & _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function InsertTP_Leasing(ByVal vp_Obj_TP_Leasing As TipoProduct_LeasingClass)
        ...
        sql.AppendLine("INSERT TIPOPRODUCTO_LEASING (" & _
            "TPL_ID," & _
            "TPL_Descripcion," & _
            "TPL_FechaActualizacion," & _
            "TPL_Usuario" & _
            ")")
        sql.AppendLine("VALUES (")
        sql.AppendLine("'" & vp_Obj_TP_Leasing.TP_Leasing_ID & "',")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function UpdateTP_Leasing(ByVal vp_Obj_TP_Leasing As TipoProduct_LeasingClass)
        ...
        Dim sql As New StringBuilder
        Dim StrQuery As String = ""
        sql.AppendLine("UPDATE TIPOPRODUCTO_LEASING SET " & _
                      " TPL_Descripcion ='" & vp_Obj_TP_Leasing.Descripcion & "', " & _
                       " TPL_FechaActualizacion ='" & vp_Obj_TP_Leasing.FechaActualizacion & "', " & _
                       " TPL_Usuario ='" & vp_Obj_TP_Leasing.Usuario & "' " & _
                       " WHERE TPL_ID = '" & vp_Obj_TP_Leasing.TP_Leasing_ID & "'")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function EraseTP_Leasing(ByVal vp_Obj_TP_Leasing As TipoProduct_LeasingClass)
        ...
        sql.AppendLine("DELETE TIPOPRODUCTO_LEASING WHERE TPL_ID = '" & vp_Obj_TP_Leasing.TP_Leasing_ID & "'")
        StrQuery = sql.ToString
        Result = conex.StrInsert_and_Update_All(StrQuery, "2")
...
#Region "CARGAR LISTAS"
    ...
    Public Function listTP_Leasing(ByVal vp_S_StrQuery As String, ByVal vg_S_StrConexion As String)
        ...
        While ReadConsulta.Read
            ...
            objTP_Leasing.TP_Leasing_ID = ReadConsulta.GetValue(0)
