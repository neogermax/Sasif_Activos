...
function transacionAjax_Causales(State, filtro, opcion) {
    var contenido;
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result == "") {
                ...
                ArrayCausales = JSON.parse(result);
                Table_Causales();
            }
        },
        error: function () {
...
/*------------------------------ crear ---------------------------*/
//hacemos la transaccion al code behind por medio de Ajax
function transacionAjax_Causales_create(State) {
...
/*------------------------------ eliminar ---------------------------*/
//hacemos la transaccion al code behind por medio de Ajax
function transacionAjax_Causales_delete(State) {
