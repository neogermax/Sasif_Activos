<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CGA/Sasif_menu.Master"
    CodeBehind="CGA_GrpMaquina.aspx.vb" Inherits="PanelSeguridad.CGA_GrpMaquina" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="CGA_GrpMaquina.js" type="text/javascript"></script>
    <script src="CGA_GrpMaquinaTrasaccionsAjax.js" type="text/javascript"></script>
            ...
            <div id="Container_controls">
                ...
                <table id="TablaDatos">
                    <tr>
                        ...
                        <td id="TD_TID">
                            <input type="text" id="Txt_ID" title="Llave Primaria" maxlength="3" />
                        ...
                        <td id="TD_Tdescrip">
                            <input type="text" id="TxtDescription" maxlength="30" title="Descripción" />
