<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CGA/Sasif_menu.Master"
    CodeBehind="CGA_Acciones.aspx.vb" Inherits="PanelSeguridad.CGA_Acciones" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="../../SasifMaster.js" type="text/javascript"></script>
    <script src="CGA_Acciones.js" type="text/javascript"></script>
    <script src="CGA_AccionesTrasaccionsAjax.js" type="text/javascript"></script>
