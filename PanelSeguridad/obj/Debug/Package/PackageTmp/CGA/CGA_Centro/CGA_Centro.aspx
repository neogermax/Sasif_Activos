<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CGA/Sasif_menu.Master"
    CodeBehind="CGA_Centro.aspx.vb" Inherits="PanelSeguridad.CGA_Centro" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="CGA_Centro.js" type="text/javascript"></script>
    <script src="CGA_CentroTrasaccionsAjax.js" type="text/javascript"></script>
            ...
            <div id="Container_controls">
                ...
                <table id="TablaDatos">
                    <tr>
                        ...
                        <td id="TD_TID">
                            <input type="text" id="Txt_ID" title="Llave Primaria" maxlength="4" />
                        ...
                        <td id="TD_Tdescrip">
                            <input type="text" id="TxtDescription" maxlength="12" title="Descripción" />
                    ...
                    <tr>
                        ...
                        <td id="TD_TPlanta">
                            <input type="text" id="TxtPlanta" maxlength="16" title="descripción de la planta" />
