<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CGA/Sasif_menu.Master"
    CodeBehind="CGA_CentroCosto.aspx.vb" Inherits="PanelSeguridad.CGA_CentroCosto" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="CGA_CentroCosto.js" type="text/javascript"></script>
    <script src="CGA_CentroCostoTrasaccionsAjax.js" type="text/javascript"></script>
            ...
            <div id="Container_controls">
                ...
                <table id="TablaDatos">
                    <tr>
                        ...
                        <td id="TD_TID">
                            <input type="text" id="Txt_ID" title="Llave Primaria" maxlength="10" class="solo-numero"/>
