...
function validarCamposCrear() {
    ...
    if (Campo_7 == "-1" || Campo_6 == "" || Campo_5 == "" || Campo_4 == "-1" || Campo_3 == "-1" || Campo_2 == "-1" || Campo_1 == "-1") {
        validar = 1;
        if (Campo_1 == "-1")
...
function Tabla_eliminar() {
    var html_Cliente = "<table id='TCliente' border='1' cellpadding='1' cellspacing='1'  style='width: 100%'><thead><tr><th colspan='9' class='Grid_Head' >Datos Generales</th><th colspan='9' class='Grid_Head' >Relacion</th></tr><tr><th>Ver</th><th>Eliminar</th><th>Nit Empresa</th><th>Tipo de Documento</th><th>N° Documento</th><th>Digito De Verificación</th><th>Nombre Empresa</th><th>Pais</th><th>Ciudad</th><th>Cliente</th><th>Avaluador</th><th>Organismo de Transito</th><th>Hacienda</th><th>Nit Multi-Empresa</th><th>Empleado</th><th>Asesor</th><th>Proveedor</th><th>Ent. Bancaria</th></tr></thead><tbody>";
...
function Editar(index_Nit, index_TDocumento, index_Documento) {
    ...
    for (itemArray in ArrayCliente) {
        if (index_Nit == ArrayCliente[itemArray].Nit_ID && index_TDocumento == ArrayCliente[itemArray].TypeDocument_ID && index_Documento == ArrayCliente[itemArray].Document_ID) {
            ...
            $("#Select_Cliente").val(ArrayCliente[itemArray].OP_Cliente);
            $("#Select_Avaluador").val(ArrayCliente[itemArray].OP_Avaluador);
            $("#Select_Transito").val(ArrayCliente[itemArray].OP_Transito);
            $("#Select_Hacienda").val(ArrayCliente[itemArray].OP_Hacienda);
            $("#Select_MultiEmp").val(ArrayCliente[itemArray].OP_Empresa);
            $("#Select_Empleado").val(ArrayCliente[itemArray].OP_Empleado);
            $("#Select_Asesor").val(ArrayCliente[itemArray].OP_Asesor);
            $("#Select_Other_1").val(ArrayCliente[itemArray].Other_1);
            $("#Select_Banco").val(ArrayCliente[itemArray].Other_2);
            ...
            setTimeout("$('#Select_Banco').trigger('change');", 200);
...
function Clear() {
    ...
    $("#Select_Cliente").val("N");
    $("#Select_Avaluador").val("N");
    $("#Select_Transito").val("N");
    $("#Select_Hacienda").val("N");
    $("#Select_MultiEmp").val("N");
    $("#Select_Empleado").val("N");
    $("#Select_Asesor").val("N");
    $("#Select_Other_1").val("N");
    $("#Select_Banco").val("N");
...
function ValideAnexos() {
    ...
    $("#Select_Cliente").change(function () {
        ...
        HabilitaAnexos(Type_id);
    });
    $("#Select_Avaluador").change(function () {
        Type_id = $(this).attr("id");
        HabilitaAnexos(Type_id);
    });
    $("#Select_Transito").change(function () {
        Type_id = $(this).attr("id");
        HabilitaAnexos(Type_id);
    });
    $("#Select_Hacienda").change(function () {
        Type_id = $(this).attr("id");
        HabilitaAnexos(Type_id);
    });
    $("#Select_MultiEmp").change(function () {
        Type_id = $(this).attr("id");
        HabilitaAnexos(Type_id);
    });
    ...
    $("#Select_Asesor").change(function () {
        Type_id = $(this).attr("id");
        HabilitaAnexos(Type_id);
    });
    $("#Select_Other_1").change(function () {
        Type_id = $(this).attr("id");
        HabilitaAnexos(Type_id);
    });
...
//verifica y muestra campos de insercion de adicional
function HabilitaAnexos(Type_id) {

    switch (Type_id) {

        case "Select_Cliente":
            if ($("#Select_Banco").val() != "S")
                $("#Anexos").css("display", "none");
            break;

        case "Select_Avaluador":
            if ($("#Select_Banco").val() != "S")
                $("#Anexos").css("display", "none");
            break;

        case "Select_Transito":
            if ($("#Select_Banco").val() != "S")
                $("#Anexos").css("display", "none");
            break;

        case "Select_Hacienda":
            if ($("#Select_Banco").val() != "S")
                $("#Anexos").css("display", "none");
            break;

        case "Select_MultiEmp":
            if ($("#Select_Banco").val() != "S")
                $("#Anexos").css("display", "none");
            break;
...
function Disabled_Client() {
    ...
    $("#Select_Avaluador").attr("disabled", "disabled");
    $("#Select_Transito").attr("disabled", "disabled");
    $("#Select_Hacienda").attr("disabled", "disabled");
    $("#Select_MultiEmp").attr("disabled", "disabled");
    $("#Select_Empleado").attr("disabled", "disabled");
    $("#Select_Asesor").attr("disabled", "disabled");
    $("#Select_Other_1").attr("disabled", "disabled");
    $("#Select_Banco").attr("disabled", "disabled");
...
function Enabled_Client() {
    ...
    $("#Select_Avaluador").removeAttr("disabled");
    $("#Select_Transito").removeAttr("disabled");
    $("#Select_Hacienda").removeAttr("disabled");
    $("#Select_MultiEmp").removeAttr("disabled");
    $("#Select_Empleado").removeAttr("disabled");
    $("#Select_Asesor").removeAttr("disabled");
    $("#Select_Other_1").removeAttr("disabled");
    $("#Select_Banco").removeAttr("disabled");
