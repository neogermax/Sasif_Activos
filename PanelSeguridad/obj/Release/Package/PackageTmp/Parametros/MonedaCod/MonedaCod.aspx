<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Parametros/Sasif_menu.Master"
    CodeBehind="MonedaCod.aspx.vb" Inherits="PanelSeguridad.MonedaCod" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="../../SasifMaster.js" type="text/javascript"></script>
    <script src="../SasifMaster_Cosult.js" type="text/javascript"></script>
    <script src="MonedaCod.js" type="text/javascript"></script>
    <script src="MonedaCodTrasaccionsAjax.js" type="text/javascript"></script>
            ...
            <div id="Container_controls">
                ...
                <table id="TablaDatos">
                    <tr>
                        ...
                        <td style="width: 80px;">
                            <span class="cssToolTip_Form">
                                <input type="text" id="Txt_Descripcion" maxlength="50" />
                                <span class="Spam_AST"></span></span>
                        </td>
                        <td style="width: 40px; padding-bottom: 25px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="cssToolTip_Form">
                                <input type="text" id="Txt_Sigla" maxlength="10" />
                                <span class="Spam_AST"></span></span>
                        </td>
