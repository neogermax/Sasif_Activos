<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Parametros/Sasif_menu.Master"
    CodeBehind="Ciudades.aspx.vb" Inherits="PanelSeguridad.Ciudades" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="../../SasifMaster.js" type="text/javascript"></script>
    <script src="../SasifMaster_Cosult.js" type="text/javascript"></script>
    <script src="Ciudades.js" type="text/javascript"></script>
    <script src="CiudadesTrasaccionsAjax.js" type="text/javascript"></script>
                ...
                <div id="TablaDatos_D">
                    ...
                    <table id="TableDatos2" style="width: 700px;">
                        <tr>
                            ...
                            <td style="width: 80px;">
                                <span class="cssToolTip_Form">
                                    <input type="text" id="Txt_ID" maxlength="5" class="solo-numero" style="width: 80px;" />
                            ...
                            <td class="Label_Bold" style="width: 20px;">
                                Nombre
                            </td>
