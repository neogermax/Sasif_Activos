    ...
    <div id="Dialog_Productos">
        ...
        <table id="Blo_Transacciones">
            ...
            <tr>
                ...
                <td>
                    <select id="Select_Crea">
                    </select>
                </td>
                <td>
                    <select id="Select_Mod">
                    </select>
                </td>
                <td>
                    <select id="Select_Ret">
                    </select>
                </td>
            </tr>
        </table>
