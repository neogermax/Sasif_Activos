<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Parametros/Sasif_menu.Master"
    CodeBehind="Relation_Tipo_Subtipo_Activo.aspx.vb" Inherits="PanelSeguridad.Relation_Tipo_Subtipo_Activo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="../../SasifMaster.js" type="text/javascript"></script>
    <script src="../SasifMaster_Cosult.js" type="text/javascript"></script>
    <script src="Relation_Tipo_Subtipo_Activo.js" type="text/javascript"></script>
    <script src="Relation_Tipo_Subtipo_ActivoTrasaccionsAjax.js" type="text/javascript"></script>
