<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Parametros/Sasif_menu.Master"
    CodeBehind="Transacciones.aspx.vb" Inherits="PanelSeguridad.Transacciones" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="../../SasifMaster.js" type="text/javascript"></script>
    <script src="../SasifMaster_Cosult.js" type="text/javascript"></script>
    <script src="Transacciones.js" type="text/javascript"></script>
    <script src="TransaccionesTrasaccionsAjax.js" type="text/javascript"></script>
        ...
        <div id="Marco_trabajo_Form">
            <div id="Container_controls">
                <table id="TablaConsulta">
                    ...
                    <tr>
                        <td colspan="4">
                            <div id="container_TTransacciones">
                            </div>
                        </td>
                    </tr>
                </table>
                        ...
                        <td style="width: 40px; padding-bottom: 25px;">
                            <span class="cssToolTip">
                                <img alt="error" title="" style="padding-left: 1em; height: 21px; width: 21px;" id="Img2"
                                    src="../../images/error.png" />
                                <span>Empresa Obligatori</span></span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 100px;">
                            <input type="text" id="Txt_ID" maxlength="7" class="Numeric" />
                        </td>
                        <td style="width: 40px; padding-bottom: 25px;">
                            <span class="cssToolTip">
                                <img alt="error" title="" style="padding-left: 1em; height: 21px; width: 21px;" id="ImgID"
                                    src="../../images/error.png" />
                                <span>Codigo Obligatorio</span></span>
                        </td>
                        <td class="Label_Bold" style="width: 70px;">
                            Descripción
                        </td>
                        <td style="width: 80px;">
                            <input type="text" id="TxtDescripcion" maxlength="30" />
                        </td>
                        <td style="width: 40px; padding-bottom: 25px;">
                            <span class="cssToolTip">
