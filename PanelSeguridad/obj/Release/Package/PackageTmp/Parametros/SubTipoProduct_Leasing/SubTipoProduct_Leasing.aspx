<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Parametros/Sasif_menu.Master"
    CodeBehind="SubTipoProduct_Leasing.aspx.vb" Inherits="PanelSeguridad.SubTipoProduct_Leasing" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="../../SasifMaster.js" type="text/javascript"></script>
    <script src="../SasifMaster_Cosult.js" type="text/javascript"></script>
    <script src="SubTipoProduct_Leasing.js" type="text/javascript"></script>
    <script src="SubTipoProduct_LeasingTrasaccionsAjax.js" type="text/javascript"></script>
